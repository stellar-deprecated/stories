...
// similar to the AMD api except that all fields are required
// all modules should be cleaned and have expected types
var stories = (function() {
  var modules = {};

  // For initializing the whole thing
  var stories = function(selector) {

  };

  // amd.js style define
  stories.define = function(id, dependencies, factory) {
